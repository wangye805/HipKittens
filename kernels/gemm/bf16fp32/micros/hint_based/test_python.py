...
parser.add_argument("--profiling", action='store_false', default=True)
parser.add_argument("--profiling_ref", action='store_true', default=False)
args = parser.parse_args()

N = args.N
profiling = args.profiling
profiling_ref = args.profiling_ref
...
print(f"N: {N}; profiling: {profiling}; profiling_ref: {profiling_ref}")
