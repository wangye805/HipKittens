// hk_s2_occ2_stag2pro_test.cpp — correctness for the 3-buffer ring kernel (step 2). Same CPU ref as tk32sb.
...
int main(int argc,char**argv){
    ...
    hk_s2_occ2_stag2pro<<<dim3(1),dim3(NT),shmem>>>(g); HC(hipDeviceSynchronize());
