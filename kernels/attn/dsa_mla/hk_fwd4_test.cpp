// hk_fwd4_test.cpp — self-contained correctness for hk_fwd4 (gather + loop + sink).
...
int main(int argc,char**argv){
    ...
    hk_fwd4<<<dim3(1),dim3(NT),shmem>>>(g);
    ...
    printf("HK_FWD4 NW=%d nt=%d sink=%d ninv=%d seed=%d: worst=%.5f mean=%.6f >.02=%d >.03=%d >.05=%d nan=%d %s\n",
