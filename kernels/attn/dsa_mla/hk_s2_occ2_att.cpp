// hk_s2_occ2_att.cpp — minimal single-launch driver for ATT capture of the [4x2] occ-2 kernel.
...
int main(){
    ...
    g_t g{ gl<bf16,-1,-1,-1,-1>(dQ,1,NW_MG,QB,D), gl<bf16,-1,-1,-1,-1>(dKV,1,1,T_KV,D),
           gl<bf16,-1,-1,-1,-1>(dO,1,NW_MG,QB,D), gl<int,-1,-1,-1,-1>(dT,GRID_N,1,NTILES,TILE_K),
    ...
    hk_s2_occ2<<<dim3(GRID_N),dim3(NT),shmem>>>(g);   // single launch for ATT
