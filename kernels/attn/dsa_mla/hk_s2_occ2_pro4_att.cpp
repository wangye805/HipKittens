// hk_s2_occ2_pro4_att.cpp — minimal single-launch driver for ATT capture of the streamed kernel.
...
int main(){
    ...
    hk_s2_occ2_pro4<<<dim3(GRID_N),dim3(NT),shmem>>>(g);   // single launch for ATT
