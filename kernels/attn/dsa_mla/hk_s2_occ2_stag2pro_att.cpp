// hk_s2_occ2_stag2pro_att.cpp — minimal single-launch driver for ATT capture of the streamed kernel.
...
int main(){
    ...
    hk_s2_occ2_stag2pro<<<dim3(GRID_N),dim3(NT),shmem>>>(g);   // single launch for ATT
