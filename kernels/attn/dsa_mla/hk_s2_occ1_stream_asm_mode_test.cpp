// hk_s2_occ1_stream_test.cpp — correctness for the subtile-streamed kernel. Same bf16-faithful CPU ref.
#include "hk_s2_occ1_stream_asm_mode.cpp"
...
int main(int argc,char**argv){
    ...
    hk_s2_occ1_stream<<<dim3(1),dim3(NT),shmem>>>(g); HC(hipDeviceSynchronize());
