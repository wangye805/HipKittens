// hk_s2_occ2b_test.cpp — correctness for the subtile-streamed kernel. Same bf16-faithful CPU ref.
#include "hk_s2_occ2b.cpp"
...
int main(int argc,char**argv){
    ...
    size_t shmem=131072;
    HC(hipFuncSetAttribute((void*)hk_s2_occ2b, hipFuncAttributeMaxDynamicSharedMemorySize, shmem));
    hk_s2_occ2b<<<dim3(1),dim3(NT),shmem>>>(g); HC(hipDeviceSynchronize());
    ...
    printf("HK_S2_OCC2B DC=%d nt=%d sink=%d ninv=%d seed=%d: O worst=%.5f mean=%.6f >.02=%d >.03=%d nan=%d | LSE worst=%.6f  %s\n",
