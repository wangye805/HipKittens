// hk_s2_occ2b_bench.cpp — cyc/tile for the subtile-streamed kernel. Tkg sized [NCTA] (uses blockIdx.x).
...
int main(int argc,char**argv){
    ...
    auto launch=[&]{ hk_s2_occ2b<<<dim3(NCTA),dim3(NT),shmem>>>(g); };
    ...
    printf("hk_s2_occ2b DC=%d NW=%d: NCTA=%d NTILES=%d TILE_K=%d | %.4f ms/launch, %.1f cyc/tile @ %.0fMHz (db=13926; Leon ~5336)\n",
