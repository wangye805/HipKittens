// hk_fwd3_test.cpp — self-contained correctness for hk_fwd3 (gather + loop + sink).
...
int main(int argc,char**argv){
    ...
    printf("HK_FWD3 NW=%d nt=%d sink=%d ninv=%d seed=%d: worst=%.5f mean=%.6f >.02=%d >.03=%d >.05=%d nan=%d %s\n",
