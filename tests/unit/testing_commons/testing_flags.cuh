...
#define TEST_WARP_REGISTER_TILE_MMA_SCALED
...
#define TEST_WARP_MEMORY_VEC
    ...
    defined(TEST_WARP_REGISTER_TILE_MMA) || defined(TEST_WARP_REGISTER_TILE_MMA_SCALED) || \
    defined(TEST_WARP_REGISTER_TILE_CONVERSIONS)
...
#if defined(TEST_WARP_SHARED_TILE_CONVERSIONS)
#define TEST_WARP_SHARED_TILE
#endif

#if defined(TEST_WARP_SHARED_VEC_CONVERSIONS)
#define TEST_WARP_SHARED_VEC
#endif

// Group macros

#if defined(TEST_GROUP_MEMORY_TILE_GLOBAL_TO_SHARED)
#define TEST_GROUP_MEMORY_TILE
#endif

#if defined(TEST_GROUP_MEMORY_VEC_GLOBAL_TO_SHARED)
