...
=====================
In this tutorial, you will write a very short high-performance bf16 matrix multiplication kernel that achieves
...
# MI200 devices use reduced precision bf16 and bf16 and flush input and
# output denormal values to zero. Detailed info is at: https://pytorch.org/docs/stable/notes/numerical_accuracy.html#reduced-precision-bf16-and-bf16-gemms-and-convolutions-on-amd-instinct-mi200-devices
...
for fp8_inputs in [False, True]:
    ...
    configs.append(
        triton.testing.Benchmark(
            ...
            x_vals=[1024, 2048, 4096, 8192, 16384],  # Different possible values for `x_name`
            ...
            ("bf16" if not fp8_inputs else "fp8"),  # Name for the plot, used also as a file name for saving the plot.
